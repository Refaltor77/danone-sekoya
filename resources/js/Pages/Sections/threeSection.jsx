            ...
            <div className={"container_center w-full"}>
                ...
                <div className="-translate-y-14">
                    ...
                    <h1
                        ...
                        className="text-center kga primary-color text-lg sm:text-xl lg:text-2xl"
                    >
                    ...
                    <section
                        ...
                        className="flex flex-col lg:flex-row justify-center lg:justify-between items-center gap-10 px-2 sm:px-16 lg:px-40 mt-8 lg:mt-16"
                    >
                        {/* Image of a baby */}
                        <img
                        ...
                        <article className="text-center lg:text-left">
                            ...
                            {/* Link to learn more */}
                            <Link className="text_button_link w-full kga text-white p-3 px-10 sm:px-20">
                                En savoir plus
                            </Link>
                        </article>
                    </section>
